const dataReaders = {
    readManufacturers(filter) {
        ...
        const columnMap = utils.getSheetColumnMap(sheet, TABLE_DEFINITIONS.manufacturers.NAME);
    ...
    readVendors(filter) {
        ...
        const columnMap = utils.getSheetColumnMap(sheet, TABLE_DEFINITIONS.vendors.NAME);
        const sheetData = sheet.getDataRange().getValues();
    ...
    readMaterials(filter) {
        ...
        const columnMap = utils.getSheetColumnMap(sheet, TABLE_DEFINITIONS.materials.NAME);
        const sheetData = sheet.getDataRange().getValues();
    ...
    readManufacturerMaterials(manufacturers, materials, filter) {
        ...
        const columnMap = utils.getSheetColumnMap(sheet, TABLE_DEFINITIONS.manufacturer_materials.NAME);
        const sheetData = sheet.getDataRange().getValues();
    ...
    readVendorPriceList(manufacturers, materials, vendors, manufacturerMaterials, filter) {
        ...
        const columnMap = utils.getSheetColumnMap(sheet, TABLE_DEFINITIONS.vendor_price_lists.NAME);
        const sheetData = sheet.getDataRange().getValues();
