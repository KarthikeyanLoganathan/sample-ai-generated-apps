const changeLog = {
    ...
    initializeChangeLogFromDataSheets() {
        ...
        for (const sheetName in TABLE_NAMES_TO_INDICES) {
            ...
            const tableDef = TABLE_DEFINITIONS[sheetName];
            const keyColumn = tableDef.KEY_COLUMN;
            const columnMap = utils.getSheetColumnMap(sheet, sheetName);
    ...
    * @returns {array} Array of condensed change records
    ...
    prepareCondensedChangeLogFromChangeLog(sinceEpochTimeMilliseconds) {
        ...
        const columnMap = utils.getSheetColumnMap(sheet, TABLE_DEFINITIONS.change_log.NAME);
