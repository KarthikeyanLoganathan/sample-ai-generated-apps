...
class _ManufacturerMaterialDetailScreenState
  ...
  bool get _isCreateMode => widget.manufacturerMaterial.uuid.isEmpty;
  ...
  void initState() {
    ...
    _currencyController.text = widget.manufacturerMaterial.currency ?? 'INR';
    _loadData();
  }
    ...
    if (_formKey.currentState!.validate()) {
      ...
      final manufacturerMaterial = widget.manufacturerMaterial.copyWith(
        ...
        sellingLotSize: _sellingLotSizeController.text.trim().isEmpty
            ? null
            : int.tryParse(_sellingLotSizeController.text.trim()),
