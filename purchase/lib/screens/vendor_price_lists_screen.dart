                  ...
                  fieldViewBuilder: (BuildContext context,
                    ...
                    return TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: 'Type to search...',
                        border: const OutlineInputBorder(),
                        suffixIcon: _selectedManufacturerId != null
                            ? IconButton(
                                icon: const Icon(Icons.clear),
                                onPressed: () {
                                  textEditingController.clear();
                  ...
                  fieldViewBuilder: (BuildContext context,
                    ...
                    return TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: 'Type to search...',
                        border: const OutlineInputBorder(),
                        suffixIcon: _selectedMaterialId != null
                            ? IconButton(
                                icon: const Icon(Icons.clear),
                                onPressed: () {
                                  textEditingController.clear();
                            ...
                            return Dismissible(
                              ...
                              child: ListTile(
                                title: Column(
                                  ...
                                  children: [
                                    // Line 1: Vendor, Manufacturer
                                    Text(
                                      '${vplWithDetails.vendorName} - ${vplWithDetails.manufacturerName}',
                                      style: const TextStyle(
                                        fontWeight: FontWeight.w500,
                                      ),
                                    ),
                                    const SizedBox(height: 4),
                                    // Line 2: Material, Model, Unit
                                    Text(
                                      '${vplWithDetails.materialName} - ${vplWithDetails.manufacturerMaterialModel} | ${vplWithDetails.materialUnitOfMeasure}',
                                      style: TextStyle(
                                        fontSize: 13,
