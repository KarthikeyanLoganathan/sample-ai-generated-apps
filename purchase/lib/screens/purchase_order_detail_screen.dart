...
class _PurchaseOrderDetailScreenState extends State<PurchaseOrderDetailScreen> {
  ...
  void initState() {
    super.initState();
    _currencyController.text = widget.purchaseOrder.currency ?? 'INR';
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          ...
          '${_amountBalance > 0 ? '\n\n⚠️ Warning: There is still an outstanding balance of ${_amountBalance.toStringAsFixed(2)} ${_currencyController.text} that has not been paid.' : ''}',
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context, false),
                ...
                children: [
                  ...
                  pw.Expanded(
                    ...
                    child: pw.Column(
                      ...
                      children: [
                        pw.Text(
                          'Total Amount: ${_totalAmount.toStringAsFixed(2)} ${_currencyController.text}',
                          style: pw.TextStyle(
                            fontSize: 13,
                            fontWeight: pw.FontWeight.bold,
                          ),
                        ...
                        pw.Text(
                            'Base Price: ${_basePrice.toStringAsFixed(2)} ${_currencyController.text}',
                            style: const pw.TextStyle(fontSize: 10)),
                        pw.SizedBox(height: 3),
                        pw.Text(
                            'Tax Amount: ${_taxAmount.toStringAsFixed(2)} ${_currencyController.text}',
                            style: const pw.TextStyle(fontSize: 10)),
                        pw.SizedBox(height: 3),
                        pw.Text(
                            'Paid: ${_amountPaid.toStringAsFixed(2)} ${_currencyController.text}',
                            style: const pw.TextStyle(fontSize: 10)),
                        pw.SizedBox(height: 3),
                        pw.Text(
                            'Balance: ${_amountBalance.toStringAsFixed(2)} ${_currencyController.text}',
                            style: const pw.TextStyle(fontSize: 10)),
                      ],
                    ),
                  ),
                ...
                children: [
                  ...
                  pw.TableRow(
                    ...
                    children: [
                      ...
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(5),
                        child: pw.Text(_basePrice.toStringAsFixed(2),
                            textAlign: pw.TextAlign.right,
                            style: pw.TextStyle(
                                fontWeight: pw.FontWeight.bold, fontSize: 9)),
                      ),
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(5),
                        child: pw.Text(_taxAmount.toStringAsFixed(2),
                            textAlign: pw.TextAlign.right,
                            style: pw.TextStyle(
                                fontWeight: pw.FontWeight.bold, fontSize: 9)),
                      ),
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(5),
                        child: pw.Text(_totalAmount.toStringAsFixed(2),
                            textAlign: pw.TextAlign.right,
                            style: pw.TextStyle(
                                fontWeight: pw.FontWeight.bold, fontSize: 9)),
                      ),
                      ...
                      return pw.TableRow(
                        children: [
                          ...
                          pw.Padding(
                            padding: const pw.EdgeInsets.all(5),
                            child: pw.Text(
                                '${payment.currency ?? 'INR'} ${payment.amount.toStringAsFixed(2)}',
                                style: const pw.TextStyle(fontSize: 9)),
                          ),
                          pw.Padding(
                            padding: const pw.EdgeInsets.all(5),
          ...
          children: [
            DropdownButtonFormField<Vendor>(
              ...
              items: _vendors
                  ...
                  .toList(),
              onChanged: widget.purchaseOrder.completed || _items.isNotEmpty
                  ? null
                  : (value) => _onVendorChanged(value),
            ),
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          '${_totalAmount.toStringAsFixed(2)} ${_currencyController.text}',
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          '${_amountPaid.toStringAsFixed(2)} ${_currencyController.text}',
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          '${_amountBalance.toStringAsFixed(2)} ${_currencyController.text}',
                          style: TextStyle(
                    ...
                    children: _payments.asMap().entries.map((entry) {
                      ...
                      return Dismissible(
                        ...
                        child: Card(
                          ...
                          child: ListTile(
                            title: Text(
                              '${payment.amount.toStringAsFixed(2)} ${payment.currency ?? 'INR'}',
                              style: const TextStyle(
                                fontWeight: FontWeight.w500,
                              ),
                            ),
...
class _PaymentDialogState extends State<_PaymentDialog> {
  ...
  void initState() {
    ...
    _currencyController = TextEditingController(
      text: widget.payment?.currency ?? widget.currency ?? 'INR',
    );
