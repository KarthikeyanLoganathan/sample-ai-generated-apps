...
class _VendorPriceListDetailScreenState
  ...
  void initState() {
    ...
    _currencyController.text = widget.vendorPriceList.currency ?? 'INR';
  ...
  Future<void> _save() async {
    if (_formKey.currentState!.validate()) {
      ...
      // Check for duplicate - when creating new or when vendor/manufacturer material changed
      ...
      final duplicate = existingPriceLists.any((vpl) =>
          vpl.uuid != widget.vendorPriceList.uuid && // Exclude current record
